  ...
  return ( 
    <div className="flex">
      <div className="w-full flex xl:flex-row flex-col items-start justify-between mb-[64px] md:mb-[196px] bg-P2-50 py-[19px] pb-[32px] md:pb-[46px] md:pt-[46px] xl:pl-0 xl:pr-0 pl-[33px] pr-[29px]">
          <div className="flex xl:w-[50%] w-full xl:justify-center xl:mb-0 mb-[35px] md:mb-[34px]">
            <div className="xl:text-34/48 md:w-[45%] text-16/22 text-[#0B3E66] font-[800] flex justify-left">What makes us the right choice?</div>
          </div>
          <div
