...
export default function Banner() {
  return (
    <div className="flex">
      <div className="w-full xl:flex-row flex-col max-w-[1440px] xl:pl-[180px] xl:pr-0 xl:ml-auto flex xl:items-start justify-between pb-[5px]">
          <div className="flex flex-col xl:max-w-[505px] w-full max-w-full mt-[64px] pl-[67px] pr-[67px] xl:pr-0 xl:pl-0">
            <div className="text-47/62 text-blue-color font-[800] w-full xl:max-w-[400px] max-w-full mb-[42px]">Unlock the potential of your <span className="text-green-color">digital journey</span> with innovation</div>
