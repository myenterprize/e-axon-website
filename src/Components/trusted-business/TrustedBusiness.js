...
export default function TrustedBusiness() {
  return (
    <div className="flex">
      <div className="w-full xl:flex-row flex-col xl:max-w-[1440px] max-w-full xl:pl-[180px] ml-auto flex items-center justify-between pb-[176px]">
          ...
          <div className="flex items-center gap-x-[74px] bg-P2-50 border-l-1 border-[#075085] h-[104px] xl:pl-[55px] xl:pr-[80px] pl-4 pr-4 xl:w-auto w-full justify-center">
