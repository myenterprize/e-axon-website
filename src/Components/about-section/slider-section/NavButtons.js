...
const NavButtons = () => {
  ...
  return (
    <div className="swiper-nav-btns flex justify-center items-center gap-[190px]">
      <Image className='cursor-pointer rotate-180 w-[32px] h-[32px]' src={Arrow} onClick={() => swiper.slidePrev()}/>
      ...
      <Image className='cursor-pointer w-[32px] h-[32px]' src={Arrow} onClick={() => swiper.slideNext()}/>
    </div>
  )
}
