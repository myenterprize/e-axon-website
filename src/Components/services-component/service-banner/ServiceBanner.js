...
const ServiceBanner = ({ banner, title, description }) => {
  return (
    <div className='w-[90%] h-[230px] md:h-[320px] lg:max-w-[80%] lg:h-[600px] relative mt-0 md:mt-8  mb-[140px]  bg-cover' style={{ backgroundImage: `url(${banner.src})`, backgroundSize: 'cover' }}>
      <div className="detail w-[70%] lg:w-[40%] md:py-5 drop-shadow-md absolute left-1/2 bottom-[-140px] -translate-x-1/2 lg:right-5 lg:top-1/2 lg:-translate-x-[-90px] text-center lg:text-start">
