...
import HeroTheFa from '@/assets/images/hero-fa.png'
import React from 'react'
import TBanner from '@/Components/talent-banner/TBanner'
import TalentBanner from '@/assets/images/compition-banner.jpg'
  ...
  return (
    <div className="w-full mx-auto">
      ...
      <div className="w-full flex flex-col justify-start items-center mt-0 md:my-53">
        ...
        <HeroSection heroImage={HeroTheFa} aboutText="Edge a leading California-based outsourcing firm, relies on E-Axon's innovative platform for efficient offshore hiring solutions. With our platform, clients seamlessly manage offshore teams and payroll, leveraging detailed employee profiles for optimal team matching. Powered by AWS infrastructure, our platform operates smoothly with Node.js and React technologies, ensuring reliability and performance" industry="Tech" companySize="100+" Year="20XX" />
