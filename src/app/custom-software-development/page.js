  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col justify-center items-center">
        ...
        <div className='texting-section w-full bg-P1-50 pt-[15px] md:pt-[55px] px-0 md:px-[50px] lg:px-[150px] flex flex-col md:flex-row justify-between items-start mt-[65px] md:mt-[80px] lg:mt-0'>
