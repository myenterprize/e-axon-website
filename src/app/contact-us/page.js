    ...
    <div className="w-full mx-auto">
     ...
     <div className='w-full mb-[190px] md:mb-[30px] md:py-[40px] flex flex-col justify-center items-center sm:px-[32px]'>
      ...
      <div className='pt-[15px] w-full lg:w-[900px] relative md:mb-[200px]'>
        ...
        <div className="contact-card h-[137px] w-[calc(100%-30px)] px-[8px] py-[15px] md:w-[85%] md:h-[200px] lg:w-[800px] lg:h-[180px] rounded-[8px] text-center md:text-start bg-S1-400 md:px-[38px] md:py-[20px] absolute left-1/2 -translate-x-1/2 bottom-[-100px] lg:bottom-[-60px] lg:left-[202px] lg:-translate-x-0">
