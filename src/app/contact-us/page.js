    ...
    <>
     ...
     <div className='w-full mb-[170px] md:mb-[20px] md:py-[40px] flex flex-col justify-center items-center px-[32px]'>
      ...
      <div className='pt-[15px] w-full lg:w-[900px] relative md:mb-[200px]'>
        ...
        <div className="contact-card h-[137px] w-[263px] px-[8px] py-[15px] md:w-[85%] sm:h-[160px] md:h-[200px] lg:w-[800px] lg:h-[180px] rounded-[8px] text-center md:text-start bg-S1-400 md:px-[38px] md:py-[20px] absolute left-1/2 -translate-x-1/2 bottom-[-100px] lg:bottom-[-80px] lg:left-[180px] lg:-translate-x-0">
