...
const ResultSection = ({resultTitle, rtColor, percentage1, prograsstext1, percentage2, prograsstext2,ratingColor, leftBorder}) => {
  ...
  return (
    <div className='w-full md:w-[80%] pt-20 flex flex-col justify-center items-center md:items-start'>
      ...
      <div className="rating-list w-full py-10 flex flex-row md:flex-col items-start md:items-end">
        <Rating percentage={percentage1} text={prograsstext1} classes="text-start pe-[30px]" lineColor={ratingColor} ratingBorder={leftBorder}/>
